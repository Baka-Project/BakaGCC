...
enum opt_code
{
  ...
  OPT__param_modref_max_adjustments_ = 258,  /* --param=modref-max-adjustments= */
  ...
  OPT_Wanalyzer_use_of_uninitialized_value = 458,/* -Wanalyzer-use-of-uninitialized-value */
  ...
  OPT_Warray_compare = 465,                  /* -Warray-compare */
  ...
  OPT_Winterference_size = 600,              /* -Winterference-size */
  ...
  OPT_Wmissing_requires = 635,               /* -Wmissing-requires */
  ...
  OPT_ftrivial_auto_var_init_ = 1583,        /* -ftrivial-auto-var-init= */
  ...
  OPT_list = 1697,                           /* -list */
  OPT_mabi_ = 1698,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1699,             /* -mabort-on-noreturn */
  OPT_mandroid = 1700,                       /* -mandroid */
  OPT_mapcs = 1701,                          /* -mapcs */
  OPT_mapcs_frame = 1702,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1703,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1704,              /* -mapcs-stack-check */
  OPT_march_ = 1705,                         /* -march= */
  OPT_marm = 1706,                           /* -marm */
  OPT_masm_syntax_unified = 1707,            /* -masm-syntax-unified */
  OPT_mbe32 = 1708,                          /* -mbe32 */
  OPT_mbe8 = 1709,                           /* -mbe8 */
  OPT_mbig_endian = 1710,                    /* -mbig-endian */
  OPT_mbionic = 1711,                        /* -mbionic */
  OPT_mbranch_cost_ = 1712,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1713,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1714,     /* -mcaller-super-interworking */
  OPT_mcmse = 1715,                          /* -mcmse */
  OPT_mcpu_ = 1716,                          /* -mcpu= */
  OPT_mfdpic = 1717,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1718,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_m3_ldrd = 1719,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1720,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1721,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1722,                  /* -mfp16-format= */
  OPT_mfpu_ = 1723,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1724,             /* -mgeneral-regs-only */
  OPT_mglibc = 1725,                         /* -mglibc */
  /* OPT_mhard_float = 1726, */              /* -mhard-float */
  OPT_mlibarch_ = 1727,                      /* -mlibarch= */
  OPT_mlittle_endian = 1728,                 /* -mlittle-endian */
  OPT_mlong_calls = 1729,                    /* -mlong-calls */
  OPT_mmusl = 1730,                          /* -mmusl */
  OPT_mneon_for_64bits = 1731,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1732,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1733,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1734,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1735,               /* -mprint-tune-info */
  OPT_mpure_code = 1736,                     /* -mpure-code */
  OPT_mrestrict_it = 1737,                   /* -mrestrict-it */
  OPT_msched_prolog = 1738,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1739,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1740,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1741, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1742,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1743,                         /* -mthumb */
  OPT_mthumb_interwork = 1744,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1745,                  /* -mtls-dialect= */
  OPT_mtp_ = 1746,                           /* -mtp= */
  OPT_mtpcs_frame = 1747,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1748,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1749,                         /* -mtune= */
  OPT_muclibc = 1750,                        /* -muclibc */
  OPT_munaligned_access = 1751,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1752,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1753,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1754,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1755,              /* -mword-relocations */
  OPT_n = 1756,                              /* -n */
  OPT_name_sort = 1757,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1758,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1759,              /* -no-integrated-cpp */
  OPT_no_pie = 1760,                         /* -no-pie */
  OPT_nocpp = 1761,                          /* -nocpp */
  OPT_nodefaultlibs = 1762,                  /* -nodefaultlibs */
  OPT_nolibc = 1763,                         /* -nolibc */
  OPT_nophoboslib = 1764,                    /* -nophoboslib */
  OPT_nostartfiles = 1765,                   /* -nostartfiles */
  OPT_nostdinc = 1766,                       /* -nostdinc */
  OPT_nostdinc__ = 1767,                     /* -nostdinc++ */
  OPT_nostdlib = 1768,                       /* -nostdlib */
  OPT_o = 1769,                              /* -o */
  OPT_objects = 1770,                        /* -objects */
  OPT_p = 1771,                              /* -p */
  OPT_pass_exit_codes = 1772,                /* -pass-exit-codes */
  /* OPT_pedantic = 1773, */                 /* -pedantic */
  OPT_pedantic_errors = 1774,                /* -pedantic-errors */
  OPT_pg = 1775,                             /* -pg */
  OPT_pie = 1776,                            /* -pie */
  OPT_pipe = 1777,                           /* -pipe */
  OPT_posix = 1778,                          /* -posix */
  OPT_print_file_name_ = 1779,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1780,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1781,          /* -print-multi-directory */
  OPT_print_multi_lib = 1782,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1783,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1784,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1785,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1786,               /* -print-prog-name= */
  OPT_print_search_dirs = 1787,              /* -print-search-dirs */
  OPT_print_sysroot = 1788,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1789,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1790,                    /* -print-value */
  OPT_profile = 1791,                        /* -profile */
  OPT_pthread = 1792,                        /* -pthread */
  OPT_quiet = 1793,                          /* -quiet */
  OPT_r = 1794,                              /* -r */
  OPT_rdynamic = 1795,                       /* -rdynamic */
  ...
  OPT_time = 1881,                           /* -time */
  OPT_time_ = 1882,                          /* -time= */
  OPT_tno_android_cc = 1883,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1884,                 /* -tno-android-ld */
  OPT_traditional = 1885,                    /* -traditional */
  OPT_traditional_cpp = 1886,                /* -traditional-cpp */
  OPT_tree_stats = 1887,                     /* -tree-stats */
  OPT_trigraphs = 1888,                      /* -trigraphs */
  OPT_type_stats = 1889,                     /* -type-stats */
  OPT_u = 1890,                              /* -u */
  OPT_undef = 1891,                          /* -undef */
  OPT_v = 1892,                              /* -v */
  OPT_version = 1893,                        /* -version */
  OPT_w = 1894,                              /* -w */
  OPT_wrapper = 1895,                        /* -wrapper */
  OPT_x = 1896,                              /* -x */
  OPT_z = 1897,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
